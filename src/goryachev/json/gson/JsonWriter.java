	...
	implements Closeable, Flushable
{
	 ...
	 * bracket.
	 */
	protected JsonWriter open(JsonScope empty, String openBracket) throws IOException
	{
		beforeValue(true);
		push(empty);
	 ...
	 * given bracket.
	 */
	protected JsonWriter close(JsonScope empty, JsonScope nonempty, String closeBracket) throws IOException
	{
	...
	protected void string(String value) throws IOException
	{
	...
	protected void newline(int delta) throws IOException
	{
		if(indent == null)
		{
			return;
